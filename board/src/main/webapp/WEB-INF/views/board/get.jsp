...
<h1 class="page-header my-4"><i class="fas fa-file-alt"></i> ${board.title}</h1>
...
<div class="mt-4">
    <a href="list" class="btn btn-primary"><i class="far fa-list"></i> 목록</a>
    <a href="update?no=${board.no}" class="btn btn-primary"><i class="far fa-edit"></i> 수정</a>
    <a href="#" class="btn btn-primary delete"><i class="far fa-trash-alt"></i> 삭제</a>
</div>
